...
export default function SandboxDatatablePage() {
  ...
  return (
    <main className="p-8">
      <div className="mb-4">
        <h1 className="text-2xl font-bold mb-4">Sandbox: DataTable Avançada</h1>
        <p className="text-muted-foreground mb-4">
          Esta é uma área de testes para a tabela de dados avançada. Aqui você pode experimentar diferentes recursos e configurações.
        </p>
